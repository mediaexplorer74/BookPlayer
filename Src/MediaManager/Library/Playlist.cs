...
// Type: MediaManager.Library.Playlist
...
{
  public class Playlist : ContentItem, IPlaylist, IContentItem, INotifyPropertyChanged
  {
    private string _uri;
    ...
    public virtual TimeSpan TotalTime
    {
      ...
      set => this.SetProperty<TimeSpan>(ref this._totalTime, value, nameof (TotalTime));
    }
